...
from app.views.inputs.strategies.shared_widgets import widget_growth_rate, widget_high_growth_years
...
class DDMView(BaseStrategyView):
    ...
    def render_model_inputs(self) -> None:
        ...
        st.number_input(
            ...
            key=f"{prefix}_{UIKeys.DIV_BASE}",
        )
        st.divider()
        self._render_step_header(Texts.STEP_2_TITLE, Texts.STEP_2_DESC)
        widget_growth_rate(label=CommonTerminals.INP_GROWTH_G, key_prefix=prefix)
