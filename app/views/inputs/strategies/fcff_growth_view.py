...
class FCFFGrowthView(BaseStrategyView):
    ...
    def render_model_inputs(self) -> None:
        ...
        with c2: st.number_input(Texts.INP_REV_GROWTH, value=None, format="%.2f", help=Texts.HELP_REV_GROWTH, key=f"{prefix}_growth_rate")
        with c3: st.number_input(Texts.INP_MARGIN_TARGET, value=None, format="%.2f", help=Texts.HELP_MARGIN_TARGET, key=f"{prefix}_fcf_margin")
        st.divider()