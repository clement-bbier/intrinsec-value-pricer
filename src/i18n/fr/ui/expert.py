...
class FCFFStandardTexts(SharedTexts):
    ...
    STEP_1_TITLE = "Étape 1 : Ancrage du Flux"
    STEP_1_DESC = "Définition du flux de trésorerie disponible pour la firme (FCFF) de référence."
    STEP_1_FORMULA = r"FCFF = EBIT \times (1 - t) + DA - \Delta WCR - Capex"
    INP_BASE = "Flux FCFF de base (Ancrage)"
    HELP_BASE = "Flux de trésorerie opérationnel net des investissements, disponible pour tous les apporteurs de capitaux."
    STEP_2_TITLE = "Étape 2 : Projection de la Croissance"
    STEP_2_DESC = "Définition de la trajectoire de croissance explicite et de l'horizon temporel."
    INP_GROWTH_G = "Taux de croissance annuel (g)"
...
class FCFFNormalizedTexts(SharedTexts):
    ...
    STEP_1_DESC = "Estimation d'un flux de croisière lissé sur 3 à 5 ans pour stabiliser la base de valorisation."
    ...
    HELP_GROWTH = "Taux de croissance de croisière projeté pour le flux lissé."

class FCFFGrowthTexts(SharedTexts):
    TITLE = "FCFF : Modèle de Croissance & Marges"
    DESCRIPTION = "Valorisation par les revenus et convergence vers une marge cible."
    STEP_1_TITLE = "Étape 1 : Assiette de Revenus"
    STEP_1_DESC = "Définition du chiffre d'affaires TTM (Trailing Twelve Months) de référence."
    STEP_1_FORMULA = r"FCF_t = Revenue_0 \times (1+g)^t \times Margin_{target}"
    INP_BASE = "Chiffre d'Affaires (Revenue)"
    HELP_REV_TTM = "Revenus totaux générés au cours des 12 derniers mois."
    STEP_2_TITLE = "Étape 2 : Convergence des Marges"
    STEP_2_DESC = "Hypothèses de croissance des revenus et de marge FCF cible à terme."
    INP_REV_GROWTH = "Taux de croissance CA (g)"
    HELP_REV_GROWTH = "Croissance annuelle attendue du chiffre d'affaires sur l'horizon de projection."
    INP_MARGIN_TARGET = "Marge FCF cible"
    HELP_MARGIN_TARGET = "Marge de flux de trésorerie disponible visée à la fin de la période de convergence."

class RIMTexts(SharedTexts):
    TITLE = "Revenu Résiduel (RIM)"
    DESCRIPTION = "Valorisation par la Valeur Comptable brute et les profits anormaux (Ohlson Model)."
    STEP_1_TITLE = "Étape 1 : Ancrage Bilanciel (BV₀)"
    STEP_1_DESC = "Saisie de la Valeur Comptable initiale (Equity) servant de socle fondamental au modèle."
    STEP_1_FORMULA = r"P = BV_0 + \sum_{t=1}^{n} \frac{NI_t - (k_e \cdot BV_{t-1})}{(1+k_e)^t} + TV_{RI}"
    INP_BV_INITIAL = "Valeur comptable initiale (Book Value)"
    HELP_BV_INITIAL = "Capitaux propres comptables (Equity) constituant le socle de la valeur d'ancrage."
    INP_NI_TTM = "Résultat Net normatif (Net Income)"
...
class GrahamTexts(SharedTexts):
    ...
    DESCRIPTION = "Formule révisée de Benjamin Graham pour l'évaluation défensive des bénéfices."
    STEP_1_TITLE = "Étape 1 : Bénéfices & Croissance"
    STEP_1_DESC = "Saisie des bénéfices normalisés et de la croissance attendue."
    STEP_1_FORMULA = r"V = \frac{EPS \times (8.5 + 2g) \times 4.4}{Y}"
    INP_EPS_NORM = "Bénéfice par action (EPS)"
    HELP_EPS_NORM = "Bénéfice par action normalisé (Trailing Twelve Months)."
    INP_GROWTH_G = "Croissance attendue (g)"
    HELP_GROWTH_LT = "Taux de croissance annuel estimé pour les 7 à 10 prochaines années."
    STEP_2_TITLE = "Étape 2 : Conditions de Marché"
    STEP_2_DESC = "Paramètres de rendement obligataire et fiscalité."
    INP_YIELD_AAA = "Rendement Corporate AAA (Y)"
    HELP_YIELD_AAA = "Rendement actuel des obligations d'entreprises notées AAA (taux sans risque ajusté)."
    INP_TAX = "Taux d'imposition"
    HELP_TAX = "Taux effectif moyen d'imposition de l'entreprise."
    NOTE_GRAHAM = "Note : Le multiplicateur 8.5 correspond à une entreprise à croissance nulle."

class FCFETexts(SharedTexts):
    TITLE = "Flux de Trésorerie Actionnaires (FCFE)"
    DESCRIPTION = "Valorisation directe des fonds propres via les flux résiduels post-dette."
    STEP_1_TITLE = "Étape 1 : Ancrage Actionnaire"
    STEP_1_DESC = "Définition du flux FCFE et de la variation de l'endettement."
    STEP_1_FORMULA = r"FCFE = OCF - Capex + \Delta \text{Net Borrowing}"
    INP_BASE = "FCF Actionnaire (FCFE)"
    HELP_FCFE_BASE = "Flux de trésorerie disponible pour les actionnaires après réinvestissement et service de la dette."
    INP_NET_BORROWING = "Variation de l'endettement"
    HELP_NET_BORROWING = "Montant net des nouvelles émissions de dette moins les remboursements."
    STEP_2_TITLE = "Étape 2 : Horizon de Projection"
    STEP_2_DESC = "Paramétrage de la croissance et de la durée de projection."

class DDMTexts(SharedTexts):
    TITLE = "Modèle d'Actualisation des Dividendes (DDM)"
    DESCRIPTION = "Valorisation basée sur la distribution future de cash aux actionnaires."
    STEP_1_TITLE = "Étape 1 : Flux de Dividendes"
    STEP_1_DESC = "Ancrage du dividende par action (DPA) de référence."
    STEP_1_FORMULA = r"V_0 = \sum_{t=1}^{n} \frac{D_t}{(1+k_e)^t} + \frac{TV_n}{(1+k_e)^n}"
    INP_BASE = "Dividende par action de base"
    INP_DIVIDEND_BASE = "Dividende par action de base"
    HELP_DIVIDEND_BASE = "Dividende versé (TTM) ou dividende annuel annoncé pour l'exercice en cours."
    STEP_2_TITLE = "Étape 2 : Dynamique de Croissance"
    STEP_2_DESC = "Projection de la croissance du dividende sur l'horizon explicite."
    NOTE_DDM_SGR = "Note : Le taux de croissance peut être arbitré par le taux de rétention des bénéfices."