...
Version : V8.1 — Waterfall Deep Fetch & None-Safe Integration
...
class YahooFinanceProvider(DataProvider):
    ...
    # ==========================================================================
    # 2. RECONSTRUCTION DES DONNÉES (WATERFALL LOGIC)
    # ==========================================================================
    ...
    def _handle_missing_ticker(self, ticker: str) -> CompanyFinancials:
        """Gère les tickers manquants avec tentative de suffixe."""
        suffixes = [". PA", ".US", ".L", ".DE"]
