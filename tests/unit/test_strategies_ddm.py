...
class TestDDMStrategy:
    ...
    def basic_params(self):
        ...
        strategy = DDMParameters(dividend_per_share=3.00, projection_years=5)
    ...
    def test_execute_with_manual_growth_vector(
        ...
        strategy_params = DDMParameters(
            dividend_per_share=3.00, projection_years=3, manual_growth_vector=[0.10, 0.08, 0.05]
        )
        common = CommonParameters(
    ...
    def test_execute_with_missing_dividend(
        self, mock_per_share, mock_discount, mock_tv, mock_project, mock_rate, strategy, basic_params
    ):
