...
class TestGrahamStrategy:
    ...
    def test_execute_with_glass_box_disabled(self, mock_graham_calc, strategy, basic_company, basic_params):
        ...
        # Setup mock
        mock_graham_calc.return_value = (180.0, CalculationStep(step_key="GRAHAM", label="Graham Value", result=180.0))
    ...
    def test_zero_eps_handling(self, mock_graham_calc, strategy, basic_params):
        ...
        # Setup mock
        mock_graham_calc.return_value = (0.0, CalculationStep(step_key="GRAHAM", label="Graham Value", result=0.0))
