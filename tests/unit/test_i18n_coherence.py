...
class TestI18nClassAttributes:
    ...
    def test_calculation_errors_has_string_attributes(self):
        ...
        string_attrs = [attr for attr in attrs if isinstance(getattr(CalculationErrors, attr, None), str)]
    ...
    def test_common_texts_has_string_attributes(self):
        ...
        string_attrs = [attr for attr in attrs if isinstance(getattr(CommonTexts, attr, None), str)]
    ...
    def test_registry_texts_has_string_attributes(self):
        ...
        # At least one should be a string
        string_attrs = [attr for attr in attrs if isinstance(getattr(RegistryTexts, attr, None), str)]
