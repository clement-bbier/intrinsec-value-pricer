...
from src.computation.flow_projector import SimpleFlowProjector, MarginConvergenceProjector
...
def test_value_per_share_sbc_expense_no_dilution(mock_params_with_sbc_expense):
    ...
    # Check step interpretation mentions no dilution
    assert "no dilution adjustment" in step.interpretation.lower()
